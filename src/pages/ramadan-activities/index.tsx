      ...
      <PageContainer>
        ...
        <div className={classNames(pageStyles.container, styles.contentPage)} dir="ltr">
          <div className={styles.subSection} id="mindful">
            ...
            <ReadMoreCollapsible section={Section.MINDFUL_FASTING}>
              <div>
                ...
                to read reflections from the community. (If you already have a QuranKhmer account -
          ...
          <div className={styles.subSection}>
            <h1>Learning Plans on QuranKhmer 📖</h1>
            <div>
          ...
          <div className={styles.subSection}>
            ...
            <div>
              ...
              to QuranKhmer and begin reading to start your Streak! You can also create a custom goal
            ...
            <ReadMoreCollapsible section={Section.INVITE_PEOPLE}>
              <>
                <div>
                  ...
                  Visit <InlineLink text="QuranKhmer/about-the-Quran" href="/about-the-quran" /> to
