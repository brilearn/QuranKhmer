      ...
      <PageContainer>
        <div className={styles.contentPage} dir="ltr">
          <div className={styles.section}>
            ...
            <div>
              We welcome you to QuranKhmer and invite you to read and listen to the Quran with an
              ...
              QuranKhmer beneficial and pray that the message of the Quran will enrich your life’s
              journey.
            </div>
          </div>
          <div className={styles.section}>
          ...
          <div className={styles.section}>
            <h1>How can QuranKhmer help me on my Quran journey?</h1>
            <div>
              QuranKhmer is a comprehensive online platform that provides a range of features to help
            ...
            <div>
              Another feature of QuranKhmer is the Reflections section, which provides a space for
            ...
            <div>
              For those who prefer to listen to the recitation of the Quran, QuranKhmer offers a
            ...
            <div>
              To further aid users in their understanding of the Quranic text, QuranKhmer provides
            ...
            <div>
              Additionally, QuranKhmer offers{' '}
