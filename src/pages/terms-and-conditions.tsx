      ...
      <PageContainer>
        <div className={styles.contentPage}>
          ...
          <p>
            ...
            ("YOU,""YOUR" OR "YOURSELF") AND QuranKhmerr ("OUR,""US,""WE" OR "QuranKhmerer"), WHICH
          ...
          <p>
            ...
            BUTTON, DOWNLOADING OR USING THE QuranKhmerr MOBILE APPLICATION, (THE "MOBILE
          ...
          <p>
            ...
            YOU MAY NOT USE THE QuranKhmerr MOBILE APPLICATION TO WHICH THIS AGREEMENT APPLIES.
            QuranKhmer is provided and managed by Quran Foundation, Inc. Anytime QuranKhmer is
            mentioned it is also referring to Quran Foundation, Inc.
          </p>
          <h2>0. GENERAL</h2>
          <p>
            0.1 QuranKhmer HAS A 0 TOLERANCE POLICY FOR ABUSIVE, SEXUAL, OR QUESTIONABLE CONTENT.
          ...
          <p>
            ...
            necessarily reflect the views of QuranKhmerr or Quran Foundation, Inc.
          </p>
          <p>
          ...
          <p>
            1.1 The Service shall include, without limitation (i) the QuranKhmerr Mobile Application,
            together with various other QuranKhmerrr powered mobile applications and certain
            ...
            personalized content, and interactive tools provided by QuranKhmerr that may be used or
            accessible by means of the Mobile Application or via our websites.
          </p>
          <p>
            1.2 The Mobile Application, is licensed, not sold, to you by QuranKhmerr. Your use of the
          ...
          <p>
            ...
            include those found at http://QuranKhmer, without limitation.
          </p>
          <p>
          ...
          <p>
            ...
            Agreement by visiting QuranKhmer/terms-and-conditions.
          </p>
          <p>
            ...
            Policy by visiting https://QuranKhmer/privacy
          </p>
          <h2>2. MOBILE APPLICATION LICENSE GRANT AND RESTRICTIONS ON USE OF THE SERVICE.</h2>
          <p>
            2.1 QuranKhmer grants You a revocable, non-exclusive, non-transferrable, limited right to
          ...
          <p>
            ...
            QuranKhmer or its affiliates, partners, suppliers or the licensors of the Service or
            ...
            QuranKhmer) other than one authorized pursuant to this Agreement; (ix) use the Service to
          ...
          <p>
            ...
            that QuranKhmer and its affiliates and their respective employees are expressly permitted
            to use the Service for the internal business purposes of QuranKhmer and its affiliates).
            ...
            without the prior written consent of QuranKhmer. In addition, you will not use the
          ...
          <p>
            ...
            QuranKhmer or a third party, and you may be subject to both this Agreement and the terms
          ...
          <p>
            2.5 QuranKhmer does not warrant that the Service will be compatible or interoperable with
            ...
            our websites. You acknowledge and agree that QuranKhmer and its affiliates, partners,
          ...
          <p>
            ...
            relating to your use of the Service, and agree to notify QuranKhmer of any third party
            claims relating to the Service of which you become aware. Furthermore, you hereby
            release QuranKhmer from any liability resulting from your use of the Service, including,
          ...
          <p>
            2.8 You acknowledge that QuranKhmer may from time to time issue upgraded versions of the
          ...
          <p>
            ...
            as otherwise noted, QuranKhmer does not charge for the use of Service, but carrier rates
          ...
          <p>
            ...
            Service. QuranKhmer makes no warranty with respect to the accuracy of Service provided to
          ...
          <p>
            3.4 You may be required to register and create an account ("Account") with QuranKhmer in
          ...
          <p>
            ...
            temporarily or permanently cease use of the Service without notice to QuranKhmer.
          </p>
          ...
          <p>
            ...
            even if such information is not collected by QuranKhmer. It is your responsibility to
          ...
          <p>
            ...
            QuranKhmer through, or in connection with, the Service is subject to our Privacy Policy,
          ...
          <p>
            ...
            QuranKhmer does not knowingly collect personal information from children through the
            Service; for questions about our online Privacy Policy for children you can find our
            privacy policy located at https://QuranKhmer/privacy.
          </p>
          ...
          <p>
            ...
            Service, (iv) the QuranKhmer company names, logos, and all related products and service
            ...
            QuranKhmer, its wholly-owned subsidiaries, affiliates, licensors, suppliers or other
            third parties. Except as expressly and unambiguously provided herein, you do not
            possess, and QuranKhmer does not grant to you, any express or implied rights (whether by
            ...
            QuranKhmer, its subsidiaries, parent companies, affiliates and/or any third party owner
            of such rights. You acknowledge and agree that you, and not QuranKhmer or any third party
          ...
          <p>
            6.1 QuranKhmer may, but is not obligated to, offer interactive features that allow users
            ...
            Service, you hereby grant to QuranKhmer a limited license to use, modify, delete from,
            ...
            discretion without notice or liability. QuranKhmer has the right, but not the obligation,
            ...
            this Agreement, and to take any action that QuranKhmer in its sole discretion deems
            ...
            other relationship is created between you and QuranKhmer by reason of your transmitting
          ...
          <p>
            ...
            the Service. QuranKhmer may not have knowledge of, and is not responsible for, the
            content, information, services, products or advertisements presented by any Other Site
            which you use at your own risk. QuranKhmer does not warrant or make any representation
            ...
            constitute an endorsement by QuranKhmer of any Other Site(s) or resources, or their
            ...
            to your access and use of them. QuranKhmer accepts no responsibility for the content or
            conduct of Other Sites
          </p>
          <p>
            7.3 QuranKhmer makes no representations whatsoever concerning (1) the information,
            ...
            Content Provider Service or Other Sites. QuranKhmer shall not be responsible or liable,
          ...
          <p>
            8.4 QuranKhmer makes no representation that any third party mobile device platform or
            ...
            QuranKhmer generally. In no event shall any third party mobile device platform or service
          ...
          <p>
            ...
            provided via a third party’s player and is hosted on a third party’s servers; QuranKhmer
            ...
            accordance with its copyright policies; and (2) contact QuranKhmer by sending us notice
            in accordance with Section 15, below
          </p>
          <h2>10. QuranKhmer DISCLOSURES</h2>
          <p>
          ...
          <p>
            ...
            material connection between QuranKhmer and the providers of the products and services
            displayed. It should be noted that this is not always the case.
          </p>
          <p>
            10.3 QuranKhmer will always recommend products and services based in part on a good faith
            belief that the supply of such products or services will help you. We have a good faith
            belief, because QuranKhmer has either tried the products or services prior to making any
            recommendations, or we have researched the products or services based on the supplier’s
            history. The recommendations made by QuranKhmer about the products or services are honest
          ...
          <p>
            ...
            Service on behalf of QuranKhmer. They are treated as average user expectations based on
          ...
          <p>
            ...
            and any use of the Internet generally shall be at your sole risk. QuranKhmer disclaims
          ...
          <p>
            ...
            OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. QuranKhmer
            ...
            OUR WEBSITES, THE SERVICE AND ANY CONTENT. QuranKhmer DOES NOT WARRANT THAT ANY DEFECTS
          ...
          <p>
            11.3 QuranKhmer DISCLAIMS, TO THE FULLEST EXTENT PERMITTED UNDER LAW, ANY AND ALL
          ...
          <p>
            11.4 NO ADVICE OR INFORMATION PROVIDED BY QuranKhmer, ITS AFFILIATES, OR THEIR RESPECTIVE
            EMPLOYEES AND AGENTS SHALL CREATE ANY WARRANTY.
          </p>
          <p>
            11.5 NONE OF QuranKhmer, ITS AFFILIATES, OR ANY ASSOCIATED MOBILE DEVICE PLATFORM AND
          ...
          <p>
            11.7 NEITHER QuranKhmer, NOR ANY OF ITS ASSOCIATED MOBILE DEVICE PLATFORM AND SERVICE
            ...
            QuranKhmer AND ITS AFFILIATES, PARTNERS, SUPPLIERS, LICENSORS, AND ASSOCIATED MOBILE
          ...
          <p>
            12.1 IN NO EVENT SHALL QuranKhmer OR ANY OF ITS ASSOCIATED MOBILE DEVICE PLATFORM AND
            ...
            PROPERTY INFRINGEMENT, TORT (INCLUDING NEGLIGENCE) OR OTHER THEORY, EVEN IF QuranKhmer OR
            ...
            SERVICE. NEITHER QuranKhmer, NOR ANY OF ITS ASSOCIATED MOBILE DEVICE PLATFORM OR SERVICE
          ...
          <p>
            12.4 WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, QuranKhmer'S AGGREGATE LIABILITY
            TO YOU (WHETHER UNDER CONTRACT, TORT, STATUTE OR OTHERWISE) SHALL NOT EXCEED THE AMOUNT
            OF FIFTY DOLLARS ($50.00).
          </p>
          <h2>13. INDEMNIFICATION.</h2>
          <p>
            13.1 You agree to indemnify and hold QuranKhmer and, as applicable, our parent,
            ...
            agreement with QuranKhmer on the basis of this Agreement); (ii) your use or misuse of any
          ...
          <p>
            13.3 QuranKhmer reserves the right, at its own expense, to assume the exclusive defense
          ...
          <p>
            QuranKhmer respects the copyright rights of others, and we ask user of Service, our
          ...
          <p>
            ...
            UNDER DMCA AND WE DO NOT REPRESENT ANY RELATED UNDERTAKING BY QuranKhmer NOT OTHERWISE
            EXPRESSLY REQUIRED BY APPLICABLE LAW.
          </p>
          <h2>15. TERMINATION.</h2>
          <p>
            QuranKhmer may, in its sole and absolute discretion, at any time and for any or no
            ...
            without any notice or other action by QuranKhmer. Upon the termination, you shall cease
            all use of the Service and/or uninstall the Mobile Application from your Mobile Device.
            QuranKhmer reserves the right to terminate or disable all or any portion of the Service,
            our websites or of the Mobile Application (via update of the Mobile Application).
          </p>
          <h2>16. REMEDIES AVAILABLE TO US.</h2>
          <p>
            QuranKhmer reserves the right to seek any and all remedies available at law or in equity
          ...
          <p>
            You acknowledge and agree that it is the intent of both you and QuranKhmer to limit the
          ...
          <p>
            ...
            between you and QuranKhmer with respect to your use of the Service, and it supersedes and
            replaces all prior or contemporaneous communications, proposals, understandings or
            agreement, whether electronic, oral or written, between you and QuranKhmer with respect
          ...
          <p>
            ...
            acknowledge and agree that each of QuranKhmer's associated mobile device platform and
          ...
          <p>
            ...
            and signed by you and QuranKhmer. Our failure to enforce our rights and remedies
          ...
          <p>
            20.6 To be removed from future QuranKhmer marketing e-mail campaigns, please e-mail
          ...
          <p>
            QuranKhmer reserves the right to add, delete, change or modify parts of this Agreement at
