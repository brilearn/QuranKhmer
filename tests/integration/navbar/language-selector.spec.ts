...
test('Clicking on Nav bar language selector icon should open the language selector menu', async ({
  ...
  await expect(page.locator('div[role="menuitem"]:has-text("বাংলা")')).not.toBeVisible();
  await expect(page.locator('div[role="menuitem"]:has-text("فارسی")')).not.toBeVisible();
  await expect(page.locator('div[role="menuitem"]:has-text("Français")')).toBeVisible();
  await expect(page.locator('div[role="menuitem"]:has-text("Italiano")')).not.toBeVisible();
  await expect(page.locator('div[role="menuitem"]:has-text("Dutch")')).not.toBeVisible();
  await expect(page.locator('div[role="menuitem"]:has-text("Português")')).not.toBeVisible();
  await expect(page.locator('div[role="menuitem"]:has-text("русский")')).not.toBeVisible();
  await expect(page.locator('div[role="menuitem"]:has-text("Shqip")')).not.toBeVisible();
  ...
  await expect(page.locator('div[role="menuitem"]:has-text("اردو")')).not.toBeVisible();
