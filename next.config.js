...
// Removed the 'withPWA' plugin as it was causing a warning
...
const config = {
  ...
  // Removed invalid properties from pwa section (assuming you don't need PWA functionality)
  // pwa: {
...
  [withTM, withBundleAnalyzer, withFonts, nextTranslate],
  config,
);
